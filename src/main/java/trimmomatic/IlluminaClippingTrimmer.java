...
public class IlluminaClippingTrimmer implements Trimmer, Serializable
{
	...
	public static IlluminaClippingTrimmer makeIlluminaClippingTrimmer(Logger logger, String seqs,int seedMaxMiss,int minPalindromeLikelihood,int minSequenceLikelihood) throws IOException
	{

		int minPrefix=8;
		IlluminaClippingTrimmer trimmer=new IlluminaClippingTrimmer(logger, seedMaxMiss, minPalindromeLikelihood, minSequenceLikelihood, minPrefix);
	...
	public IlluminaClippingTrimmer(Logger logger, int seedMaxMiss, int minPalindromeLikelihood, int minSequenceLikelihood, int minPrefix)
	{
		this.logger=logger;
	...
	class IlluminaLongClippingSeq extends IlluminaClippingSeq implements Serializable
	{
