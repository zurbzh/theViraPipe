...
also tools for sequence data normalization and filtration as well as SQL query interfaces for querying the data in parallel. Code for the trimming tool in this pipeline is adopted from the source code of Trimmomatic (http://www.usadellab.org/cms/?page=trimmomatic)
